...
\textbf{AutoSP (ours)} & \textbf{65K} & \textbf{25K} & \textbf{10K} & \textbf{8} & 27 & \textbf{188} \\
\bottomrule[1.6pt]
\end{tabular}%
}
\vspace{-8pt}
...
\item {\bf Theory assumptions and proofs}
    ...
    \item[] Answer: \answerYes{}
    \item[] Justification: Section~\ref{sec:experimental_design} and Appendix~\ref{sec:appendix_a} provide model architectures, optimizer hyperparameters (including sweep results), sequence-parallel configuration, batch sizes, learning rate schedules, and random seeds. The training data (FineWeb-Edu) is publicly available.
    \item[] Guidelines:
    \begin{itemize}
...
\item {\bf Experimental setting/details}
    ...
    \item[] Answer: \answerYes{}
    \item[] Justification: Section~\ref{sec:experimental_design} describes the experimental setup. Appendix~\ref{sec:appendix_a} provides full architecture details, hyperparameter sweep procedures, and the final selected hyperparameters for each configuration.
    \item[] Guidelines:
    \begin{itemize}
        \item The answer \answerNA{} means that the paper does not include experiments.
